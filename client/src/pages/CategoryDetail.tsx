...
import {
  ...
  ChevronDown, ArrowUpDown, ArrowUp, ArrowDown, Layers,
} from "lucide-react";
...
function WireItemReelSection({ item }: { item: CategoryGroupedItem }) {
  const { toast } = useToast();
  const qc = useQueryClient();
    ...
    <div className="space-y-6">
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-xl bg-[#16202e]" style={{ height: "210px" }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 z-30 p-6">
          ...
          {/* CATEGORY PAGE TITLE — locked at 1.875rem/bold. Do not reduce this size. */}
          <h1
          ...
          {displayGroups.map((group) => {
            ...
            return (
              ...
              >
                ...
                <div className={`flex items-center justify-between px-5 border-b min-h-[60px] ${isEditingThis ? "bg-amber-50/60 border-amber-200" : "border-slate-200 bg-slate-50/80"}`}>
                  <div className="flex items-center gap-3 py-3 flex-1 min-w-0">
                    ...
                    <div className="min-w-0 flex-1">
                      {/* FAMILY NAME — locked at text-base/semibold. Do not reduce. */}
                      <h3
                ...
                {/* Items — card grid in view mode, table in edit mode */}
                {isEditingThis ? (
